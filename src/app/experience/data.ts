...
export const workSlotData: WorkSlotData[] = [
	...
	},
	{
		...
		description:
			"Interned with the Spectrum Portfolio Management Team, where I worked on migration of legacy monolithic projects to microservices architecture on AWS",
	...
	},
	{
		...
		description:
			"Worked on VisualRLComposer, a GUI for facilitating the experimentation of Reinforcement Learning using OpenAI Gym, Stable Baselines 3 and PyTorch.",
