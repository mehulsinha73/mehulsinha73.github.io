...
export function ProjectCard(data: ProjectCardData) {
	return (
		<AnimateUpIntoView>
			...
			>
				<MorphingDialogTrigger className="flex max-w-80 rounded-xl flex-col overflow-hidden border bg-sidebar">
					<MorphingDialogImage
						src={data.thumbnail}
					...
					<div className="flex grow flex-row items-end justify-between px-3 py-2">
						...
						<PlusIcon
							size={12}
							className={cn(
								"relative ml-1 flex h-6 w-6 shrink-0 scale-100 select-none items-center justify-center",
				...
				<MorphingDialogContainer>
					...
					>
						...
						/>
						<div className="p-6">
							<MorphingDialogTitle className="text-xl sm:text-2xl">
								{data.title}
							</MorphingDialogTitle>
